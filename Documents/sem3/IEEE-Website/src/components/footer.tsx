    ...
    <footer className="bg-background border-t border-border py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-4">IEEE CIET</h3>
            <p className="text-sm text-muted-foreground">Empowering technology for humanity</p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/team" className="text-sm hover:text-primary">Team</Link></li>
