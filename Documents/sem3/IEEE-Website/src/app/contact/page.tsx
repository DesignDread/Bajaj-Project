        ...
        <div>
            <div className="h-[120svh]">
                <div className="flex">
                    ...
                    >
                        <h1 className="text-4xl text-center mt-4 font-semibold mb-4 p-8">
                            Get In Touch With Us!
                        </h1>
                        <p className="mx-auto text-xl font-semibold mb-20">
                        ...
                        <motion.button
                            variants={formVariants}
                            onClick={Submission}
                            className="bg-blue-600 hover:bg-blue-700 my-4 h-12 w-48 mx-auto text-white text-lg px-8 py-2 rounded-full"
                        >
                            Contact Us!
                        </motion.button>
                    </motion.form>
